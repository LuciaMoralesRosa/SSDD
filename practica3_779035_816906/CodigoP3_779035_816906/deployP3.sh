...
# -----------------------------------------------------------------------------#
# Despliegue desde central de la carpeta "práctica3" en todas las máquinas     #
# -----------------------------------------------------------------------------#
...
do
  ...
  ssh "$USER@$ip" "cd /home/$USER && rm -r practica3"

  # Copiar todos los ficheros de la práctica
  scp -r "/home/$USER/Practicas/SSDD/practica3" "$USER@$ip:/home/$USER"
done
